...
queue_url = "https://sqs.us-east-1.amazonaws.com/981263172079/DeclineTeamInviteQueue"
def lambda_handler(event, context):
    ...
    if 'Messages' in response:
        ...
        email_subject = "Team Invite Declined!"
        email_body = f"{invitee} has declined your invite to team {team_name}!"
