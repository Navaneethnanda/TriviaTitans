...
export default function EditQuestion() {
    ...
    const [question, setQuestion] = useState(state.result);
    ...
    useEffect(() => {
        ...
        try {
            ...
            const response = await axios.post('https://907fx2wvif.execute-api.us-east-1.amazonaws.com/Dev/question', dataVal);
  ...
  const handleDifficultyLevelChange = (e) => {
    ...
    <div className="flex items-center justify-center ">
      ...
      <div className="bg-white w-full sm:w-[480px] margin top mt-6 p-8 rounded-md shadow-sm border-[1px]">
        <div className="font-bold text-2xl mb-4  " >Update Question For Game</div>
        ...
        <form action="#">
          ...
          <div className="flex   items-center mt-3">
            <div className="bg-[#C1292E] p-3 text-white font-bold text-xl max-w-fit rounded-md cursor-pointer">
              <input type="submit" value="Update" className="cursor-pointer" onClick={handleSubmit} />
            </div>
          </div>
        </form>
      </div>
